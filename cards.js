...
var cards = (function() {
  ...
  Card.prototype = {
    init: function(suit, rank, table) {
      ...
      // this.showCard(); // I commented this out
      this.moveToFront();
    },
    ...
    render: function(options) {
      ...
      var flip = function() {
        for (var i = 0; i < me.length; i++) {
          if ((me.faceUp) || (me[i].faceUp)) { // I added second condition
            me[i].showCard();
          } else {
            me[i].hideCard();
          }
